 ...
 * [496d123a](https://github.com/rmg/scaffold-shootout/commit/496d123) - rails new rails-blog
 * [2cc35259](https://github.com/rmg/scaffold-shootout/commit/2cc3525) - rails g scaffold User name:string email:string:uniq
 * [0b233dee](https://github.com/rmg/scaffold-shootout/commit/0b233de) - rails g scaffold Post title:text body:text user:references
 * [4b71510b](https://github.com/rmg/scaffold-shootout/commit/4b71510) - rails g scaffold Comment body:text post:references user:references
 ...
 * [d5d839a](https://github.com/rmg/scaffold-shootout/commit/d5d839a) - lb app (empty)
 * [ed4f0a5](https://github.com/rmg/scaffold-shootout/commit/ed4f0a5) - lb model Author
 * [25a6737](https://github.com/rmg/scaffold-shootout/commit/25a6737) - lb model Post
 * [89fc033](https://github.com/rmg/scaffold-shootout/commit/89fc033) - lb model Comment
 * [ca4c60a](https://github.com/rmg/scaffold-shootout/commit/ca4c60a) - lb relation (Post belongs to Author)
 * [0cb228a](https://github.com/rmg/scaffold-shootout/commit/0cb228a) - lb relation (Comment belongs to Author)
 * [950bce4](https://github.com/rmg/scaffold-shootout/commit/950bce4) - lb relation (Comment belongs to Post)
 ...
 * [0fc813f](https://github.com/rmg/scaffold-shootout/commit/0fc813f) - mix phoenix.new phoenix_blog
 * [07de996](https://github.com/rmg/scaffold-shootout/commit/07de996) - mix phoenix.gen.html User users name:string email:string
 * [7dc08e4](https://github.com/rmg/scaffold-shootout/commit/7dc08e4) - phoenix_blog: manually add resource route
 * [a2b22c8](https://github.com/rmg/scaffold-shootout/commit/a2b22c8) - mix phoenix.gen.html Post posts title:string body:text author:references:users
 * [c603e41](https://github.com/rmg/scaffold-shootout/commit/c603e41) - phoenix_blog: manually add /posts resource route
 * [5463926](https://github.com/rmg/scaffold-shootout/commit/5463926) - mix phoenix.gen.html Comment comments body:text author:references:users post:references:posts
 * [3a762e4](https://github.com/rmg/scaffold-shootout/commit/3a762e4) - phoenix_blog: manually add /comments resource route
 ...
 * [694eb6c](https://github.com/rmg/scaffold-shootout/commit/694eb6c) - sails generate new sails-blog
 * [3b47aa0](https://github.com/rmg/scaffold-shootout/commit/3b47aa0) - sails generate model User name:string email:string
 * [a78549e](https://github.com/rmg/scaffold-shootout/commit/a78549e) - sails generate controller User create show index update delete
 * [b5b7416](https://github.com/rmg/scaffold-shootout/commit/b5b7416) - sails generate model Post title:string body:text
 * [ee3d761](https://github.com/rmg/scaffold-shootout/commit/ee3d761) - sails generate controller Post create show index update delete
 * [9dc7b93](https://github.com/rmg/scaffold-shootout/commit/9dc7b93) - sails generate model Comment body:text
 * [49435d9](https://github.com/rmg/scaffold-shootout/commit/49435d9) - sails generate controller Comment create show index update delete
 * [c3aa32f](https://github.com/rmg/scaffold-shootout/commit/c3aa32f) - sails: manually add relations to models
 ...
 * [21e837b](https://github.com/rmg/scaffold-shootout/commit/21e837b) - yo swiftserver
 * [9c7f29e](https://github.com/rmg/scaffold-shootout/commit/9c7f29e) - yo swiftserver:model User
 * [c26b651](https://github.com/rmg/scaffold-shootout/commit/c26b651) - yo swiftserver:model Post
 * [e74e523](https://github.com/rmg/scaffold-shootout/commit/e74e523) - yo swiftserver:model Comment
